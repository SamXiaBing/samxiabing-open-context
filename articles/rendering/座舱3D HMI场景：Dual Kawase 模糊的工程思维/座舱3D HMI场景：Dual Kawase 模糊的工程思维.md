---
title: "座舱3D HMI场景：Dual Kawase 模糊的工程思维"
date: 2026-07-08
series: rendering
no: 
status: published
...
全局模糊这种Render Feature很常见，也很容易找到资源，但是了解它的机制对于了解图像的渲染过程和一些精妙的数学原理很有帮助。过段时间不看，咱可能也不一定能记得住具体的 hlsl 是怎么写的，但升降采样的工程思路，会一直影响我们。
